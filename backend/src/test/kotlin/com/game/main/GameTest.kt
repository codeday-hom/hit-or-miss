...
//        game.mixOrder()
        ...
        val firstTurn = game.startTurn(game.currentPlayer(), "Ocean Animals", DiceResult.HIT, "Shark")
        ...
        val secondTurn = game.startTurn(game.nextPlayer(), "Fruits", DiceResult.HIT, "Apple")
    ...
    fun `play a turn with a miss`() {
        ...
        // Ian's turn is first and randomly selects a category
        // Ian rolled the dice and shared a word
        val ianTurn = game.startTurn(game.currentPlayer(), "Ocean Animals", DiceResult.MISS, "Shark")
        ...
        val Turn = game.startTurn(game.nextPlayer(), "Veggies", DiceResult.MISS, "Carrot")
