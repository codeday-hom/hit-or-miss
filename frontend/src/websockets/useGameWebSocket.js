...
export default function useGameWebSocket(gameId, playerId, onMessageFunction) {
  const url = playerId === null
    ? new URL(`/ws/game/${gameId}`, window.location.href)
    : new URL(`/ws/game/${gameId}/${playerId}`, window.location.href);
